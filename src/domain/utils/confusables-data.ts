/**
 * Unicode confusable character data — owned by the domain layer.
 *
 * Moved here from infrastructure/security to respect DIP:
 * the domain layer defines what it needs, infrastructure implements it.
 */
